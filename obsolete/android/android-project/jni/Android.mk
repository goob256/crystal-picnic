...
LOCAL_LDLIBS    := -L$(ANDROID_DIR)/$(TARGET_ARCH_ABI)/lib -L$(LOCAL_PATH)/$(TARGET_ARCH_ABI) -llog -ltgui2-old libs/$(TARGET_ARCH_ABI)/liballegro_monolith.so -llua5.2 -lz -lbassmidi -lbass -lpoly2tri-old -lGLESv1_CM -lstdc++
